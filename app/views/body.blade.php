...
<title>Sistema de Gestión de Incidencias de Equipos</title>
<style type="text/css">
<!--
body {
...
<div class="container">
  <div class="header"><a href="#"><img src="{{URL::to('/')}}/banner.png" alt="Insertar logotipo aquí" name="Insert_logo" width="100%" id="Insert_logo" style="background: #8090AB; display:block; background-color: #FFFFFF;" /></a>
    <!-- end .header --></div>
  <div class="sidebar1">
    <div align="right">
      <ul id="MenuBar1" class="MenuBarVertical">
        ...
        <li><a href="{{ action('HomeController@logOut') }}">Cerrar Sesion</a></li>
      </ul>
    </div>
  </div>
  <div class="content">
